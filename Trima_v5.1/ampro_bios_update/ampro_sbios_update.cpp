...
// Initial revision
//
// Ampro safety board (Core/4DXe) BIOS update program
//
...
enum { FlashSize = 0x10000 };
enum { FlashAddress = 0xd0000 };

#include "safety_image.cpp"
...
void main(void)
{
	...
	//
	// Enabling the programming switch (and having called mapBiosImage)
